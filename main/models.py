...
class Opportunity(models.Model):
    ...
    phone_number1 = models.CharField(max_length=32, blank=True, null=True)
    phone_number2 = models.CharField(max_length=32, blank=True, null=True)
    ...
    last_agent = models.CharField(max_length=32, blank=True, null=True)
    last_crawl = models.DateTimeField(blank=True, null=True)
    last_result = models.CharField(max_length=32, blank=True, null=True)
